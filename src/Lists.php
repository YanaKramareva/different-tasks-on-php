 ...
 * после прохождения курса "PHP: Массивы", а также курса "PHP: Функции", в котором рассматривается Splat-оператор.
...
Другими словами, можно безболезненно переписать реализацию тех функций, которые делались в курсе, и весь код,
использующий списки, будет работать как ни в чем не бывало.
