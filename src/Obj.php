 ...
 * Объекты поддерживают одновременно два способа обращения к ним: через точку
 *  (аналог -> в PHP) и через [], как в обычных массивах.
...
Кроме этого интерфейса, нужно реализовать магические методы __get и __set,
которые дают обращаться к свойствам даже без их явного описания.
